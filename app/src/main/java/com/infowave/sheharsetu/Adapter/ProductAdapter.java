...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.VH> {
    ...
    public interface OnContactClickListener { void onContactClick(@NonNull Map<String, Object> product); }
    ...
    public void setOnContactClickListener(OnContactClickListener l) { this.contactClickListener = l; }
    ...
    static class VH extends RecyclerView.ViewHolder {
        ImageView img; TextView title, price, city; Button btn;
        VH(@NonNull View v) {
            super(v);
    ...
    private static String buildDescForPdp(String title, String price, String city) {
        ...
        if (!TextUtils.isEmpty(price)) sb.append(" • ").append(price);
        if (!TextUtils.isEmpty(city))  sb.append(" • ").append(city);
        return sb.toString();
    }
